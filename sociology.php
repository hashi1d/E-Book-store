 ...
 <body>
            <div class= "container">
                <h1>SOCIOLOGY</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/soci.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2> Introduction to Sociology</h2>
                <p> <I>  The College-Level Sociology course is designed to introduce students to the sociological study of society. Sociology focuses on the systematic understanding of social interaction, social organization, social institutions, and social change.</I> </p>
                <p> Details about the book: <br>  English Version </p>
                <span> More text about the book: </span>
                <a href = "books for the web/ln_sociology_final.pdf">
...
<div class = "rate" style ="margin-top: -425px;">
  ...
  <br>
        ...
        THANK YOU & KEEP READING......</p>
            <a href = "rating/ratingsociology.php">
            <br>
            <br>
