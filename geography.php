...
.content2 .prate{
 ...
 <body>
            <div class= "container">
                <h1 class = "h1"> GEOGRAPHY</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/geog.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2 class = "h2"> The Dictionary of Human Geography</h2>
                <p class = "p"> <I>  With clear, critical, and constructive surveys of key terms by leading researchers in the field, The Dictionary of Human Geography, fifth edition, remains the definitive guide to the concepts and debates in human geography.</I> </p>
                <p class = "p1"> Details about the book: <br>  Author: Willy Blackwell </p>
                <span class = "span"> More text about the book: </span>
                <a href = "books for the web/The Dictionary of Human Geography ( PDFDrive ).pdf">
...
<div class = "rate" style ="margin-top: -425px;">
  ...
  <br>
        ...
        THANK YOU & KEEP READING......</p>
            <a href = "rating/ratinggeography.php">
            <br>
            <br>
