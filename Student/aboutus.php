...
<body>
    <div class="aboutsec" >
            ...
            <br>
            <p class="text" style="color: red; font-size: 20px; line-height: 21px; margin-top: -1px; margin-left: 4px; font-style: italic">
            ...
            <ul>
                ...
                <p class="text" style="color:black ; font-size: 20px; line-height: 21px; margin-top: -1px; margin-left: 4px; font-style: italic">
