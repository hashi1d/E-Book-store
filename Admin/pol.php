...
.content2 .prate{
 ...
 <body>
            <div class= "container">
                <h1 class = "h1">political science</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/poli.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2 class = "h2"> political science </h2>
                <p class = "p"> <I>  Political science, occasionally called politology, is a discipline of social science which deals ... Some political scientists seek to advance positive (attempt to describe how things are, as opposed to how they should be) theses by analysing.</I> </p>
                <p class = "p1"> Details about the book: <br>  Edited by: R.A.W Rhodes</p>
                <span class = "span"> More text about the book: </span>
                <a href = "books for the web/political science ( PDFDrive ).pdf">
