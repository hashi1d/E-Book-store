...
.content2 .prate{
 ...
 <body>
            <div class= "container">
                ...
                <div class = "content">
                <h2 class = "h2"> Web Design with HTML and CSS</h2>
                <p class = "p"> <I> HTML (the Hypertext Markup Language) and CSS (Cascading Style Sheets) are two of the core technologies for building Web pages. HTML provides the structure of the page, CSS the (visual and aural) layout, for a variety of devices.</I> </p>
