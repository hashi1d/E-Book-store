 ...
 <body>
            <div class= "container">
                <h1 class = "h1"> SOFTWARE</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/soft1.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2 class = "h2"> Mastering Photoshop for Web Design</h2>
                <p class = "p"> <I>  he web design landscape is constantly changing, but Photoshop is still a classic. Designers use it to create UI elements, web graphics, wireframes, and functional mockups. Designs that transition beautifully and easily to production.</I> </p>
                <p class = "p1"> Details about the book: <br>  English Version </p>
                <span class = "span"> More text about the book: </span>
                <a href = "books for the web/Mastering Photoshop for Web Design ( PDFDrive ).pdf">
