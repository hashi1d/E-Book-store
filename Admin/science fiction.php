...
.content2 .prate{
 ...
 <body>
            <div class= "container">
                <h1 class = "h1">SCIENCE & FICTION</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/sci fic.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2 class = "h2"> The Vulcan Language </h2>
                <p class = "p"> <I> Golic Vulcan is the Vulcan language that was heard in Star Trek: The Motion Picture, Star Trek: The Wrath of Khan, and other Star Trek movies.  Terms from this language were also heard in the original Star Trek television series, later series, and some books
.</I> </p>
                <p class = "p1"> Details about the book: <br>  Version: English</p>
                <span class = "span"> More text about the book: </span>
                <a href = "books for the web/vulcanlanguage.pdf">
