 ...
 <body>
            <div class= "container">
                <h1 class = "h1"> PROGRAMMING</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/pro1.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2 class = "h2"> Beginning Programming for Dummies</h2>
                <p class = "p"> <I>Programming is the process of creating a set of instructions that tell a computer how to perform a task. Programming can be done using a variety of computer programming languages, such as JavaScript, Python, and C++.</I> </p>
                <p class = "p1"> Details about the book: <br>  Author: W Wangg</p>
                <span class = "span"> More text about the book: </span>
                <a href = "books for the web/Beginning Programming for Dummies ( PDFDrive ).pdf">
