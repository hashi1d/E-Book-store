 ...
 <body>
            <div class= "container">
                <h1  class = "h1"> HARDWARE</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/craft1.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2 class = "h2"> Digital Logic And Computer Design</h2>
                <p class = "p"> <I> This special collection of Fine Woodworking's best articles on furniture construction and anatomy comes ... You'll also get in-depth information on building doors.
.</I> </p>
                <p class = "p1"> Details about the book: <br>  Author: Suankularb Wittayalai Rangsit </p>
                <span> More text about the book: </span>
                <a href = "books for the web/Fine Woodworking 2007 Building Furniture ( PDFDrive ).pdf">
