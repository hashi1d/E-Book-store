 ...
 <body>
            <div class= "container">
                <h1 class = "h2"> HARDWARE</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/hard1.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2 class = "h2"> Digital Logic And Computer Design</h2>
                <p class = "p"> <I> Digital Logic is the basis of electronic systems, such as computers and cell phones.This system facilitates the design of electronic circuits that convey information, including logic gates. Digital Logic gate functions include and, or and not. The value system translates input signals into specific output.</I> </p>
                <p class = "p1"> Details about the book: <br>  Author: M.M Mano </p>
                <span class = "span"> More text about the book: </span>
                <a href = "books for the web/Digital Logic And Computer Design By M. Morris Mano ( PDFDrive ).pdf">
