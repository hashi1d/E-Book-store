            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <div class="logo">
                        ...
                        <img class = "img"src="images/bklogo.jpg" >
                    </div>
                ...
                <ul class="nav navbar-nav" id="myTopnav">
                    ...
                    <li>
                        <div class="dropdown" style= "margin-top: 15px;  font-size: 30px;">
                    ...
                    <?php
                        ...
                        { ?>
                                <li><a href="login.php" ><span class = "glyphicon glyphicon-log-in" style= "margin-top: 29px;  font-size: 15px; margin-left: 250px;">LOGIN</span></a></li>	
