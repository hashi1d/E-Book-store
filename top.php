        ...
        <nav class="navbar navbar-inverse" >
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav" id="myTopnav">
                    ...
                    <li>
                        <div class="dropdown" style= "margin-top: 4px;  font-size: 15px;">
                    ...
                    <?php
                        ...
                        {  ?>
                                ...
                                <li> <a href = "chatnew.php" style= "margin-top: 13px;  "> <span class = "glyphicon glyphicon-envelope">&nbsp<span class = "badge bg-green">
                                    </span></a>
                                </li>
