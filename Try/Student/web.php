 ...
 <body>
            <div class= "container">
                <h1> WEB DESIGN</h1>
                 <div class = "book">
                    <div class = "icon">
                        <img src = "images/cat/web1.jpg"  alt= ""  />
                </div>
                <div class = "content">
                <h2> Web Design with HTML and CSS</h2>
                <p> <I> HTML (the Hypertext Markup Language) and CSS (Cascading Style Sheets) are two of the core technologies for building Web pages. HTML provides the structure of the page, CSS the (visual and aural) layout, for a variety of devices.</I> </p>
                <p> Details about the book: <br> English Version </p>
                <span> More text about the book: </span>
                <a href = "books for the web/web-design-with-html-and-css-digital-classroom.pdf">
