...
<table>
		...
		{
			    echo "<tr style = 'color: black; width: 400px; margin-top: 0px; float:left;'>";    //inside that raw data are inserted below
...
<div class = "srch">
    <form class = "navbar-form" method = "post" name = "form1">
            ...
            <br>
			<label for= "Ctegory">Select the Category </label>
			<select name= "Category">
				...
				<optgroup label = "Teen & young Adult">
				</optgroup>
</br>
            </select>		
